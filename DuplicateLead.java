...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		//stateprov.selectByVisibleText("Delaware");
		 ...
		 WebElement clear = Driver.findElement(By.id("createLeadForm_companyName"));
		 clear.clear();
		 
		 WebElement dupname = Driver.findElement(By.id("createLeadForm_companyName"));
		 dupname.sendKeys("Cognizant");
		 
		 WebElement clear1 = Driver.findElement(By.id("createLeadForm_firstName"));
		 clear1.clear();
		 
		 WebElement dupname1 = Driver.findElement(By.id("createLeadForm_firstName"));
		 dupname1.sendKeys("ARUNPRASATH");
